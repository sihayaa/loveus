// js/quick-chat.js
// Mini “quick notes” wall on the homepage.
//
// This expects your main page to already create:
//   - const supabase = window.supabase.createClient(...)
//   - let CURRENT_USER = ... (after login)
//   - const ROOM_KEY = "couple";
//
// We will wait until supabase + CURRENT_USER + HTML exist, then initialize.
...
(function () {
  function canStart() {
    return (
      ...
      window.CURRENT_USER &&
      document.getElementById("quick-chat-shell")
    );
  }
  ...
  // 🔁 wait until supabase + CURRENT_USER + HTML are ready
